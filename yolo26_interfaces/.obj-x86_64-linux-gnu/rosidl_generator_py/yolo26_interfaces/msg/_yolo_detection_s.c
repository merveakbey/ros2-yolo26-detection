...
bool yolo26_interfaces__msg__yolo_detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yolo26_interfaces.msg._yolo_detection.YoloDetection", full_classname_dest, 51) == 0);
  }
  yolo26_interfaces__msg__YoloDetection * ros_message = _ros_message;
  {  // class_id
...
PyObject * yolo26_interfaces__msg__yolo_detection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("yolo26_interfaces.msg._yolo_detection");
