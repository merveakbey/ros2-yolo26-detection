...
#include "yolo26_interfaces/msg/detail/yolo_detection__rosidl_typesupport_fastrtps_c.h"
...
using _YoloDetection__ros_msg_type = yolo26_interfaces__msg__YoloDetection;
...
static uint32_t _YoloDetection__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_yolo26_interfaces__msg__YoloDetection(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yolo26_interfaces__msg__YoloDetection;
    is_plain =
      (
...
static size_t _YoloDetection__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_yolo26_interfaces__msg__YoloDetection(
