...
static const _YoloDetection_type_support_symbol_names_t _YoloDetection_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yolo26_interfaces, msg, YoloDetection)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yolo26_interfaces, msg, YoloDetection)),
  }
};
...
{
  return &::yolo26_interfaces::msg::rosidl_typesupport_cpp::YoloDetection_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, yolo26_interfaces, msg, YoloDetection)() {
  return get_message_type_support_handle<yolo26_interfaces::msg::YoloDetection>();
}
